...
class CustomerPolicyPrivacy extends StatelessWidget {
  const CustomerPolicyPrivacy({super.key});
  ...
  Widget _intro() => _bodyText(
        'ກ່ອນທີ່ທ່ານຈະເລີ່ມໃຊ້ງານ Xaosao ໃນຖານະ ຜູ້ໃຊ້ບໍລິການ, ກະລຸນາອ່ານ ເງື່ອນໄຂ ແລະ ນະໂຍບາຍ ນີ້ຢ່າງລະອຽດ ເພາະວ່ານີ້ຄືສັນຍາທາງກົດໝາຍລະຫວ່າງທ່ານ ແລະ ທີມງານ Xaosao. ການທີ່ທ່ານຍອມຮັບ ເງື່ອນໄຂ ແລະ ນະໂຍບາຍ ນີ້ຖືວ່າທ່ານໄດ້ຮັບຮູ້ ແລະ ຕົກລົງກ່ຽວກັບຂໍ້ກໍານົດທີ່ໄດ້ກ່າວໄວ້ທັງໝົດ.\n\nXaosao ເປັນພຽງ ຕົວກາງ ໃນການຊ່ວຍເຊື່ອມຕໍ່ລະຫວ່າງ ຜູ້ໃຫ້ບໍລິການ ແລະ ຜູ້ໃຊ້ບໍລິການ ໂດຍ Xaosao ຈະບໍ່ຮັບຜິດຊອບຕໍ່ກັບການກະທໍາໃດໜຶ່ງ ຫລື ພຶດຕິກໍາທີ່ເກີດຂຶ້ນ ລະຫວ່າງ ຜູ້ໃຫ້ບໍລິການ ແລະ ຜູ້ໃຊ້ບໍລິການ ໃນທຸກກໍລະນີ.',
      );
  ...
  Widget _whatIsXaosao() => Column(
        ...
        children: [
          ...
          _bullet('ເປັນ Application ສໍາລັບຜູ້ທີ່ຕ້ອງການຫາເພື່ອນ, ຄູ່ເດັດ, ຄູ່ເດີນທາງ ຫລື ຄູ່ນວດ ໃກ້ໆ ສະຖານທີ່ຂອງທ່ານ ໂດຍຜ່ານລະບົບ Xaosao'),
  ...
  Widget _sectionI() => Column(
        ...
        children: [
          ...
          _numbered(4, 'ການສະໝັກ ແລະ ໃຊ້ບໍລິການ ເປັນໄປຕາມຄວາມສະໝັກໃຈຂອງທ່ານ ໂດຍທ່ານຈະບໍ່ຖືກບັງຄັບໃດໆ'),
          _numbered(5, 'ທ່ານມີສິດ ເລືອກ ຜູ້ໃຫ້ບໍລິການ ທີ່ທ່ານຕ້ອງການໄດ້'),
          _numbered(6, 'ຫາກທ່ານ Booking ຜູ້ໃຫ້ບໍລິການ ໃດໜຶ່ງໄປແລ້ວ ແຕ່ຈໍາເປັນຕ້ອງຍົກເລີກ ທ່ານຕ້ອງແຈ້ງໃຫ້ຊາບລ່ວງໜ້າ'),
          _numbered(7, 'ທ່ານສາມາດສ້າງໄດ້ 2 ບັນຊີ ໃນ 1 ເບີໂທ ຄື ບັນຊີຜູ້ໃຊ້ 1 ບັນຊີ ແລະ ບັນຊີຜູ້ໃຫ້ບໍລິການ 1 ບັນຊີ'),
          _numbered(8, 'ທ່ານຕ້ອງ ຊໍາລະ ຄ່າບໍລິການ ຕາມຂັ້ນຕອນ Xaosao ທີ່ກໍານົດ ໃນການ ຄົ້ນຫາ ແລະ ຈອງ'),
          _numbered(9, 'ທ່ານໄດ້ອະນຸຍາດໃຫ້ລະບົບ ເຂົ້າເຖິງ ຂໍ້ມູນ, ກ້ອງຖ່າຍຮູບ, ຕໍາແໜ່ງທີ່ຢູ່ ຂອງທ່ານ'),
          _numbered(10, 'Xaosao ຂໍສະຫງວນສິດໃນການດັດແກ້ ຫລື ປ່ຽນແປງ ນະໂຍບາຍ ຫລື ເງື່ອນໄຂ ໄດ້ຕາມຄວາມເໝາະສົມ'),
          _numbered(11, 'Xaosao ຈະໃຊ້ເວລາ 3 ວັນທໍາການ ໃນການກວດສອບ ແລະ ຢັ້ງຢືນ ໂປຣໄຟລ໌ ຂອງທ່ານ'),
          _numbered(12, 'ຫາກທ່ານໄດ້ຮັບການ Approved ແລ້ວ ແຕ່ ກະທໍາ ທຳຮ້າຍຮ່າງກາຍ ຫລື ບັງຄັບ ຜູ້ໃຫ້ບໍລິການ ທາງລະບົບ Xaosao ຈະ ລຶບ ບັນຊີ ທ່ານ ທັນທີ ແລະ ດໍາເນີນຄະດີ ຕາມກົດໝາຍ'),
        ],
      );
  ...
  Widget _sectionIV() => Column(
        ...
        children: [
          ...
          _numbered(5, 'ຍອດເງິນທີ່ຢູ່ໃນ ບັນຊີທີ່ ລຶບດ້ວຍຕົນເອງ ຫລື ຖືກ ປິດ/ລຶບ ຍ້ອນຜິດນະໂຍບາຍ ຈະບໍ່ສາມາດ ຖອນເງິນ ໄດ້'),
          SizedBox(height: 4.h),
          Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                _subBullet('ຫາກ ລຶບດ້ວຍຕົນເອງ: ລະບົບຈະ ບໍ່ຄືນ ຍອດເງິນ ໃຫ້'),
                _subBullet('ຫາກ ລະບົບ ລຶບ ຍ້ອນ ຜິດນະໂຍບາຍ: ຈະ ບໍ່ຄືນ ຍອດເງິນ ແລະ ຍັງ ບວກ ຄ່າເສຍຫາຍ ອີກ'),
              ],
            ),
          ),
        ],
  ...
  Widget _sectionV() => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _sectionTitle('V. ການຄືນເງິນ'),
          SizedBox(height: 10.h),
          _numbered(1, 'ຕ້ອງຖອນຂັ້ນຕ່ຳ 100,000 ກີບ ຂຶ້ນໄປ'),
          _numbered(2, 'ມີ ຄ່າທໍານຽມ ການໂອນ 10%'),
          _numbered(3, 'ໃຊ້ເວລາດໍາເນີນການ ພາຍໃນ 7 ວັນ'),
          _numbered(4, 'ຕິດຕໍ່ Admin ໂດຍກົງ ເພື່ອດໍາເນີນການ'),
        ],
      );

  Widget _sectionVI() => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _sectionTitle('VI. ຜົນປະໂຫຍດ'),
          SizedBox(height: 10.h),
          _numbered(1, 'ຕອບສະໜອງຄວາມຕ້ອງການ ໄດ້ຢ່າງ ວ່ອງໄວ'),
          _numbered(2, 'ປະຢັດເວລາ ໃນການຄົ້ນຫາ'),
          _numbered(3, 'ມີທາງເລືອກ ຫລາກຫລາຍ ໃນການ ສ້າງ ຄວາມສຸກ ໃນການໄປຫລິ້ນ'),
          _numbered(4, 'ສ້າງ ຄວາມຮູ້ ທາງສັງຄົມ ແລະ ສ້າງ ເຄືອຂ່າຍ ໃໝ່ໆ'),
        ],
      );
  ...
  Widget _privacyPolicy() => Column(
        ...
        children: [
          ...
          _numbered(5, 'ສິດ ຄັດຄ້ານ — ທ່ານມີສິດ ຄັດຄ້ານ ການປະມວນຜົນຂໍ້ມູນ ໃນກໍລະນີ ດໍາເນີນການ ໂດຍ ອໍານາດ ສາທາລະນະ / ຜົນປະໂຫຍດສາທາລະນະ, ດ້ານ ການຕະຫລາດ ໂດຍກົງ, ດ້ານ ການຄົ້ນຄວ້າ ຫລື ສະຖິຕິ'),
  ...
  Widget _subBullet(String t) => Padding(
        padding: EdgeInsets.only(bottom: 5.h),
        child: Row(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
