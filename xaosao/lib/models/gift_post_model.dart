...
GiftPostModel giftPostModelFromJson(String str) =>
    GiftPostModel.fromJson(json.decode(str));
...
class GiftPostModel {
  ...
  GiftPostModel({this.totalGifts, this.giftSummary, this.gifts});

  factory GiftPostModel.fromJson(Map<String, dynamic> json) => GiftPostModel(
    totalGifts: json["totalGifts"],
    giftSummary: json["giftSummary"] == null
        ? []
        : List<GiftSummary>.from(
            json["giftSummary"]!.map((x) => GiftSummary.fromJson(x)),
          ),
    gifts: json["gifts"] == null
        ? []
        : List<GiftElement>.from(
  ...
  Map<String, dynamic> toJson() => {
    ...
    "giftSummary": giftSummary == null
        ? []
        : List<dynamic>.from(giftSummary!.map((x) => x.toJson())),
    "gifts": gifts == null
        ? []
...
class GiftSummary {
  ...
  GiftSummary({this.gift, this.count});
  ...
  Map<String, dynamic> toJson() => {"gift": gift?.toJson(), "count": count};
}
...
class GiftSummaryGift {
  ...
  GiftSummaryGift({this.id, this.name, this.image, this.price});

  factory GiftSummaryGift.fromJson(Map<String, dynamic> json) =>
      GiftSummaryGift(
        id: json["id"],
        name: json["name"],
        image: json["image"],
...
class Customer {
  ...
  Customer({this.id, this.profile, this.firstName, this.lastName});
